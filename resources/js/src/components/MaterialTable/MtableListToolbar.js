...
export class MTableListToolbar extends React.Component {
    state = {
    ...
    renderSearch () {
        const localization = { ...MTableListToolbar.defaultProps.localization, ...this.props.localization }
    ...
    renderMultipleHandler = () => {
        ...
        if (_.isEmpty(this.props.selectedRows)) {
            return null
        }

        const className = classNames(classes.root, {
            [classes.highlight]: this.props.showTextRowsSelected
    ...
    renderRetailers = () => {
        ...
        if (_.isEmpty(retailers) || retailers === undefined) {
            return null
        }

        return _.map(retailers, (retailer => {
            return <MenuItem key={retailer.name} value={retailer.name}> {retailer.name} </MenuItem>
        }))
    }
    ...
    render () {
        ...
        return (
            <div>
                ...
                {this.renderMultipleHandler()}
            </div>
        )
    }
}

MTableListToolbar.defaultProps = {
    actions: [],
    columns: [],
    columnsButton: false,
    localization: {

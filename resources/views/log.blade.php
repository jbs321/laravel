                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('log') }}">
                            ...
                            <div class="form-group row">
                                <label for="datetime" class="col-md-4 col-form-label text-md-right">{{ __('Date Time') }}</label>

                                <div class="col-md-6">
                                    <input id="datetime" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}" type="date" class="form-control" name="datetime" required autocomplete="datetime">
                                </div>
                            </div>
